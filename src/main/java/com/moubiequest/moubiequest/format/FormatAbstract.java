...
import com.moubiequest.api.format.FormatReplacer;
...
public abstract class FormatAbstract<T>
    ...
    // 讀取格式的文件
    protected final FormatLoader formatFile;
     ...
     * @param file 格式檔案
     */
    public FormatAbstract(final @NotNull T obj, final @NotNull FormatLoader file) {
        this.replacer = obj;
