...
package com.moubiequest.moubiequest.gui.ui;
...
import com.moubieapi.moubieapi.inventory.BackUItemStack;
import com.moubieapi.moubieapi.inventory.UInventoryAbstract;
import com.moubieapi.moubieapi.inventory.UItemStackBuilder;
import com.moubiequest.api.gui.ui.EditStatusGUI;
import com.moubiequest.api.gui.ui.QuestGUI;
import com.moubiequest.api.yaml.data.MessageData;
import com.moubiequest.api.yaml.data.TitleData;
...
public final class EditPlayerStatusUInventory
    ...
    public EditPlayerStatusUInventory(final @NotNull Player player, final @NotNull QuestGUI backer) {
        ...
        final InventoryLoader inventoryFile = MouBieCat.getInstance().getInventoryFile();
