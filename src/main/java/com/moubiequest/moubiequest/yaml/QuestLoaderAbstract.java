...
import com.moubiequest.api.yaml.quest.QuestLoader;
...
public abstract class QuestLoaderAbstract<T extends Quest>
     ...
     */
    public QuestLoaderAbstract(final @NotNull String path, final @NotNull String fileName) {
        super(path + File.separatorChar, fileName + ".yml", false);
    }
