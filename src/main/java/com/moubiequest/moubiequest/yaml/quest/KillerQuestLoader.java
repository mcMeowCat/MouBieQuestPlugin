...
package com.moubiequest.moubiequest.yaml.quest;

import com.moubiequest.api.quests.KillerQuest;
import com.moubiequest.moubiequest.quests.object.Message;
import com.moubiequest.moubiequest.quests.object.QItem;
import com.moubiequest.moubiequest.quests.object.Status;
import com.moubiequest.moubiequest.quests.object.Title;
import com.moubiequest.moubiequest.yaml.ProgressQuestLoaderAbstract;
 ...
 * @author MouBieCat
 */
public final class KillerQuestLoader
     ...
     */
    public KillerQuestLoader(final @NotNull String fileName) {
        super("KillerQuests", fileName + ".yml");
    }
     ...
     * @return 生物類型
     */
    public EntityType parsingQuestKillEntityType(final @NotNull String key) {
    ...
    public List<KillerQuest> parsing() {
        ...
        for (final String key : questSection.getKeys(false)) {
            ...
            // 創建任務
            final KillerQuest quest = new com.moubiequest.moubiequest.quests.quest.KillerQuest(
