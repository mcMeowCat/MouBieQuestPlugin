...
package com.moubiequest.moubie.yaml.quests;

import com.moubiequest.api.yaml.quests.KillerLoader;
...
public class KillerQuestLoader
    ...
    public List<KillerQuest> parsing() {
        ...
        for (final String key : questSection.getKeys(false)) {
            ...
            // 創建任務
            final com.moubiequest.moubie.quests.quest.KillerQuest quest = new com.moubiequest.moubie.quests.quest.KillerQuest(
